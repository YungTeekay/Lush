...
export function BedIcon({ size = 18 }: IconProps) {
  return (
    <svg {...base(size)}>
      ...
      <path d="M2 12h20v6" />
      <path d="M2 12v6" />
      <path d="M2 12V9a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v3" />
      <path d="M12 9h8a2 2 0 0 1 2 2v1" />
    </svg>
  );
}

export function BathIcon({ size = 18 }: IconProps) {
  return (
    <svg {...base(size)}>
...
export function CalculatorIcon({ size = 22 }: IconProps) {
  return (
    <svg {...base(size)}>
...
export function HandHeartIcon({ size = 22 }: IconProps) {
  return (
    <svg {...base(size)}>
